...
pub use core::{
    ...
    ToolsConfig, build_openai_prompt_cache_key, build_session_affinity_prompt_cache_key,
    map_prompt_cache_key_for_provider, session_affinity_key_enabled, session_affinity_provider,
