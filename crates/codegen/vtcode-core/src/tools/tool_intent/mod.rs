...
pub use activity::{
    ShellActivity, VERIFIER_SHELL_FORM_NOTE, classify_shell_activity, default_verifier_for_workspace,
    rewrite_truncation_only_verifier, shell_args_as_executed, shell_command_is_admitted_verification_attempt,
    verification_recovery_directive,
};
pub use classify::{
