...
pub const HEADER_SHORTCUT_HINT: &str = "Shortcuts: Alt+P suggest • Tab next agent • Shift+Tab previous agent • Enter run/steer • Ctrl+Enter queue • Shift+Enter newline • Esc cancel • Ctrl+C interrupt";
