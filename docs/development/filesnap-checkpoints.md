...
show only the current branch. Redo records and interrupted operations persist in
the checkpoint directory. A workspace lease excludes concurrent turns/restores.
